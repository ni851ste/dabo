...
public class UserMapAdapter implements IUserPersistenceAdapter {
    ...
    {
        Optional<Map.Entry<Integer, Ennead<String, String, Triplet<String, String, Boolean>, Integer, String, List<Integer>, List<Integer>, List<Integer>, Map<String, String>>>> foundUser = savedUsers.entrySet()
                .stream()
        ...
        if (foundUser.isPresent()) {
            return Optional.of(foundUser.get().getKey().toString());
        }
        return Optional.empty();
    }
