...
<script lang="ts">
    ...
    export default class ArticleCard extends Vue {
        ...
        mounted() : void {
            ...
            if (this.article.image !== undefined && this.article.image.length > 0 && this.article.image[0] !== "") {
                console.log("in if");
                this.firstImage = this.article.image[0];
                console.log("firstImage in ArticleCard " + this.firstImage);
                this.$forceUpdate();
            } else {
                console.log("else");
