...
<script lang="ts">
    ...
    export default class UserProfileView extends Vue {
        ...
        constructor() {
            ...
            let rating: Rating = new Rating(3, "TOLL!","Sehr zuverlässig und unkompliziert.", 1, new Date())
            let rating2: Rating = new Rating(1, "Nicht so toll!","Lorem Ipsum is simply dummy text of the printing and typesetting industry. " +
